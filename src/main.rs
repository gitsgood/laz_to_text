use laz_to_text::{LazInfo, time_it, get_laz_file, get_text_destination};
        ...
        match users_will {
            ...
            _ => {
                ...
                time_it("Printing the txt", || {
                    laz_info.print_to_text(output_path).expect("Couldn't print the txt");
                });
            }
        }
